   ...
   is
      ...
      is
         ...
         begin
            ...
            if Wanted > 0.0 then
               Total_Desire := Total_Desire + To_Quantity (Wanted);
            end if;
